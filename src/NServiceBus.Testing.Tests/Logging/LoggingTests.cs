...
{
    [TearDown]
    public void Teardown() => SomeClassThatUsesStaticLogger.Reset();
    ...
    {
        public SomeClassThatUsesStaticLogger() => InstanceCounter = instanceCounter++;

        public int InstanceCounter { get; }

        public void DoSomething() => Logger.Debug(InstanceCounter.ToString());

        public static void Reset() => instanceCounter = 0;
