...
namespace NServiceBus.Testing
{
        ...
        where T : NServiceBus.Saga
    {
        ...
        public NServiceBus.Testing.Saga<T> When(System.Action<T> sagaIsInvoked) { }
    ...
    public class Test
    {
        ...
        public static void Initialize(System.Action<NServiceBus.EndpointConfiguration> customisations = null) { }
