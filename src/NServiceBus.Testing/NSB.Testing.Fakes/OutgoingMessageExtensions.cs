...
public static class OutgoingMessageExtensions
{
    ...
    /// </summary>
    public static TMessage Message<TMessage>(this RepliedMessage<object> sentMessage) where TMessage : class => sentMessage.Message as TMessage;

    /// <summary>
    /// Tries to cast the message contained in <paramref name="sentMessage" /> to <typeparamref name="TMessage" />.
    /// </summary>
    public static TMessage Message<TMessage>(this PublishedMessage<object> sentMessage) where TMessage : class => sentMessage.Message as TMessage;

    /// <summary>
    /// Tries to cast the message contained in <paramref name="sentMessage" /> to <typeparamref name="TMessage" />.
    /// </summary>
    public static TMessage Message<TMessage>(this SentMessage<object> sentMessage) where TMessage : class => sentMessage.Message as TMessage;
}